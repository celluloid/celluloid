...
module Celluloid
  ...
  class Actor
    ...
    def initialize(subject, options = {})
      ...
      Celluloid::Monitoring.actor_created(self) if $CELLULOID_MONITORING
      ...
      Celluloid.exclusive do
        ...
        loop do
          ...
          when LinkingResponse
            Celluloid::Monitoring.actors_linked(self, receiver) if $CELLULOID_MONITORING
            # We're done!
    ...
    def handle_system_event(event)
      ...
      when NamingRequest
        @name = event.name
        Celluloid::Monitoring.actor_named(self) if $CELLULOID_MONITORING
    ...
    def cleanup(exit_event)
      Celluloid::Monitoring.actor_died(self) if $CELLULOID_MONITORING
      @mailbox.shutdown
      @links.each do |actor|
